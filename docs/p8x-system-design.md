...
Passive backplane, **DIN 41612 96-pin (rows A/B/C)** connectors on 100×160 mm Eurocards. Row B is a solid ground guard between the signal rows (B3–B26 = GND); B27 = CLRC, B28 = BSEL (rev C), B29–B30 = SPARE10–11. See [p8x-bus-definition.md](../hardware/backplane/p8x-bus-definition.md) for the full pin map.
