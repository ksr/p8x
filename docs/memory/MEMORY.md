...
- [Full 3D stack + GL SHIPPED](project_p8x_gfx_clib.md) — stage 10 GL ($FF50): 10a-d ON SILICON; 10e backed out (c0931f0, awaits successor board); 10f LINFUN PLACED 2026-08-27 at 19,048 (ellipse/circle shared-adder diets, tb_gl_cpx coverage, GMODE $FF2E) flash pending; branch graphic-test, unmerged
