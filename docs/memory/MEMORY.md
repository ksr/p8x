...
- [Full 3D stack + GL SHIPPED](project_p8x_gfx_clib.md) — stage 10 GL ($FF50): 10a-d ON SILICON; 10e backed out (c0931f0, awaits successor board); 10f LINFUN ON SILICON 2026-08-27 at 19,048 (ellipse/circle shared-adder diets, tb_gl_cpx coverage, GMODE $FF2E; XOR un-draw board-proven); MERGED to main 2026-08-27; CARD ARC COMPLETE 2026-08-28: card personality IN FLASH (no CPU on chip), emulator=CPU via p8xemu -B/runcard.sh, family golden-certified on silicon, SD-clone flow obsolete; 41 BSRAM free for 10e
