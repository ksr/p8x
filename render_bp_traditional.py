...
c.drawString(20,1190-55,"Rail glyphs = +5V / GND planes (inner layers). RT/CT clock terminators ship DNP.")
...
ROWS=( [("D%d"%i,"D") for i in range(8)]+[None]
      ...
      +[("SPARE%d"%i,"S") for i in range(8)]+[None]
      +[("+5V (A1,B1,C1,A2,B2,C2)","V"),("GND (B3-B30)","G"),("GND (31/32 ALL ROWS)","G")])
JX=0; JY=0
