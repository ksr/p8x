...
python3 $ROOT/assembler/p8xasm.py help.asm -o help.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    hlp.img help.bin --name /bin/help.bin --load 0x6300 --exec 0x6300 >/dev/null
