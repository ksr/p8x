...
python3 $ROOT/assembler/p8xasm.py gl_m.asm -o gl_m.bin --base 0x6300 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py gl_r.asm -o gl_r.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    glm.img gl_m.bin --name /bin/glm.bin --load 0x6300 --exec 0x6300 >/dev/null
python3 $ROOT/tools/p8xfs.py put    glm.img gl_r.bin --name /bin/glr.bin --load 0x6300 --exec 0x6300 >/dev/null
