...
python3 $ROOT/assembler/p8xasm.py wf_wdesk.asm -o wf_wdesk.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    wf.img wf_wdesk.bin --name /bin/wdesk.bin --load 0x5900 --exec 0x5900 >/dev/null
