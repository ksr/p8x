...
python3 $ROOT/assembler/p8xasm.py bfcat.asm -o bfcat.bin --base 0x5900 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py bfdir.asm -o bfdir.bin --base 0x5900 >/dev/null
python3 $ROOT/tools/clib.py $ROOT/os/commands/wc.c -o bfwc.c
python3 $ROOT/compiler/p8cc.py bfwc.c -o bfwc.asm >/dev/null
python3 $ROOT/assembler/p8xasm.py bfwc.asm -o bfwc.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    bf.img bfcat.bin --name /bin/cat.bin --load 0x5900 --exec 0x5900 >/dev/null
python3 $ROOT/tools/p8xfs.py put    bf.img bfdir.bin --name /bin/dir.bin --load 0x5900 --exec 0x5900 >/dev/null
python3 $ROOT/tools/p8xfs.py put    bf.img bfwc.bin  --name /bin/wc.bin  --load 0x5900 --exec 0x5900 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py bfdel.asm -o bfdel.bin --base 0x5900 >/dev/null
python3 $ROOT/tools/p8xfs.py put    bf.img bfdel.bin --name /bin/del.bin --load 0x5900 --exec 0x5900 >/dev/null
