...
python3 $ROOT/assembler/p8xasm.py s2_probe.asm -o s2_probe.bin --base 0x6100 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    s2.img s2_probe.bin --name /bin/s2.bin --load 0x6100 --exec 0x6100 >/dev/null
