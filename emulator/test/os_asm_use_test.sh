...
python3 $ROOT/assembler/p8xasm.py $ROOT/os/p8xos.asm -o osu.bin --base 0x2000 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py cat.full.asm -o cat.ref.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    use.img asm.bin --name /bin/asm.bin --load 0x6300 --exec 0x6300 >/dev/null
