...
python3 $ROOT/assembler/p8xasm.py bddir.asm -o bddir.bin --base 0x6100 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    bd.img bddir.bin --name /bin/dir.bin --load 0x6100 --exec 0x6100 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py bddep.asm -o bddep.bin --base 0x6100 >/dev/null
python3 $ROOT/tools/p8xfs.py put    bd.img bddep.bin --name /bin/dep.bin --load 0x6100 --exec 0x6100 >/dev/null
