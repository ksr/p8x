...
python3 $ROOT/assembler/p8xasm.py gl_pt.asm -o gl_pt.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    gl_pt.img gl_pt.bin --name /bin/glpt.bin --load 0x5900 --exec 0x5900 >/dev/null
...
printf "E ${GCONEN}\r00.G 014E\rB\rrun /bin/glpt.bin\r" > gl_pt.in
