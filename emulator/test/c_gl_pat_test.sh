...
python3 $ROOT/assembler/p8xasm.py gl_pt.asm -o gl_pt.bin --base 0x6100 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    gl_pt.img gl_pt.bin --name /bin/glpt.bin --load 0x6100 --exec 0x6100 >/dev/null
