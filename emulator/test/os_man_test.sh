...
python3 $ROOT/assembler/p8xasm.py man.asm -o man.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    man.img man.bin --name /bin/man.bin --load 0x5900 --exec 0x5900 >/dev/null
