...
python3 $ROOT/assembler/p8xasm.py $ROOT/os/p8xos.asm -o osm.bin --base 0x2000 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py man.asm -o man.bin --base 0x6100 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    man.img man.bin --name /bin/man.bin --load 0x6100 --exec 0x6100 >/dev/null
