...
PYEOF
python3 $ROOT/assembler/p8xasm.py cover.asm -o covgold.bin --base 0x7A00 >/dev/null
...
msg:    .asciiz "HELLO-ASM"
        .byte CR,LF
EOF
python3 $ROOT/assembler/p8xasm.py prog.asm -o golden.bin --base 0x7A00 >/dev/null
