...
python3 $ROOT/tools/p8xfs.py put    wk.img wk_stub.bin --name /bin/st.bin --load 0x6300 --exec 0x6300 >/dev/null
python3 $ROOT/tools/p8xfs.py put    wk.img wk_redraw.bin --name /bin/rd.bin --load 0x6300 --exec 0x6300 >/dev/null
