...
python3 $ROOT/assembler/p8xasm.py rp.asm -o rp.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    rs.img rp.bin  --name /bin/probe.bin --load 0x5900 --exec 0x5900 >/dev/null
