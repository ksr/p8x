...
python3 $ROOT/tools/p8xfs.py put    wl.img wl_run.bin --name /bin/wl.bin --load 0x6100 --exec 0x6100 >/dev/null
python3 $ROOT/tools/p8xfs.py put    wl.img wl_app.bin --name /bin/wapp.bin --load 0x6100 --exec 0x6100 >/dev/null
