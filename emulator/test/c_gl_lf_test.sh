...
python3 $ROOT/assembler/p8xasm.py gl_lf.asm -o gl_lf.bin --base 0x6100 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    gl_lf.img gl_lf.bin --name /bin/gllf.bin --load 0x6100 --exec 0x6100 >/dev/null
