...
python3 $ROOT/assembler/p8xasm.py wt_wdesk.asm -o wt_wdesk.bin --base 0x6100 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    wt.img wt_wdesk.bin --name /bin/wdesk.bin --load 0x6100 --exec 0x6100 >/dev/null
