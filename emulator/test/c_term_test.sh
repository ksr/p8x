...
python3 $ROOT/assembler/p8xasm.py tm.asm  -o tm.bin  --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    t.img tm.bin  --name /bin/term.bin   --load 0x6300 --exec 0x6300 >/dev/null
python3 $ROOT/tools/p8xfs.py put    t.img fnd.bin --name /bin/finder.bin --load 0x6300 --exec 0x6300 >/dev/null
