...
printf 'B\rdesk\r\033[<0;5;1M\033[<32;5;3M\033[<32;5;5M\033[<0;5;5m' > cd3.in
...
c = load("cd4.ppm")
assert p(c,300,222)==DESK,          "closed TERM still on screen"
assert p(c,60,182)==(255,255,255),  "SHAPES did not inherit focus after close"
print("menu bar+tracking, close box, card-list repaint, clip, drag: pixel-exact")
EOF

echo "C-DESK TEST: PASS (lib_wm: menu press-drag-release, close boxes, card-resident list repaint, hardware clip, drag)"
