...
python3 $ROOT/assembler/p8xasm.py cd_desk.asm -o cd_desk.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    cd.img cd_desk.bin --name /bin/desk.bin --load 0x5900 --exec 0x5900 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py cd_paint.asm -o cd_paint.bin --base 0x5900 >/dev/null
python3 $ROOT/tools/p8xfs.py put cd.img cd_paint.bin --name /bin/paint.bin --load 0x5900 --exec 0x5900 >/dev/null
