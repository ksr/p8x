...
python3 $ROOT/assembler/p8xasm.py r_app.asm -o r_app.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    fr.img r_app.bin --name /R.BIN --load 0x5900 --exec 0x5900 >/dev/null
