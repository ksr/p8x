...
python3 $ROOT/assembler/p8xasm.py r_app.asm -o r_app.bin --base 0x6100 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    fr.img r_app.bin --name /R.BIN --load 0x6100 --exec 0x6100 >/dev/null
python3 $ROOT/tools/p8xfs.py mkdir  fr.img /bin >/dev/null
python3 $ROOT/tools/p8xfs.py put    fr.img fnd.bin --name /bin/finder.bin --load 0x6100 --exec 0x6100 >/dev/null
