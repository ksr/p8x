...
python3 $ROOT/assembler/p8xasm.py gl_pr.asm -o gl_pr.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    gl_pr.img gl_pr.bin --name /bin/glpr.bin --load 0x5900 --exec 0x5900 >/dev/null
