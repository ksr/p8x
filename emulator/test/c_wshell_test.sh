...
build() {   # $1 = source, $2 = out.bin
    ...
    python3 $ROOT/assembler/p8xasm.py t.asm -o "$2" --base 0x6300 >/dev/null
}
...
python3 $ROOT/tools/p8xfs.py put    wsh.img armwin.bin  --name /bin/armwin.bin  --load 0x6300 --exec 0x6300 >/dev/null
python3 $ROOT/tools/p8xfs.py put    wsh.img showwin.bin --name /bin/showwin.bin --load 0x6300 --exec 0x6300 >/dev/null
python3 $ROOT/tools/p8xfs.py put    wsh.img pwd.bin     --name /bin/pwd.bin     --load 0x6300 --exec 0x6300 >/dev/null
