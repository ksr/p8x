...
python3 $ROOT/tools/p8xfs.py put    sw.img sw_run.bin --name /bin/sw.bin --load 0x6100 --exec 0x6100 >/dev/null
python3 $ROOT/tools/p8xfs.py put    sw.img sw_app.bin --name /bin/wapp.bin --load 0x6100 --exec 0x6100 >/dev/null
python3 $ROOT/tools/p8xfs.py put    sw.img sw_chk.bin --name /bin/chk.bin --load 0x6100 --exec 0x6100 >/dev/null
