...
python3 $ROOT/assembler/p8xasm.py ev_run.asm -o ev_run.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    ev.img ev_run.bin --name /bin/ev.bin --load 0x6300 --exec 0x6300 >/dev/null
