...
python3 $ROOT/assembler/p8xasm.py apcat.asm -o apcat.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    ap.img apcat.bin --name /bin/cat.bin --load 0x6300 --exec 0x6300 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py aphelp.asm -o aphelp.bin --base 0x6300 >/dev/null
python3 $ROOT/tools/p8xfs.py put    ap.img aphelp.bin --name /bin/help.bin --load 0x6300 --exec 0x6300 >/dev/null
printf 'oneline\n' > apin.dat
