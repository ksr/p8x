...
python3 $ROOT/assembler/p8xasm.py gl_a.asm -o gl_a.bin --base 0x6300 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py gl_b.asm -o gl_b.bin --base 0x6300 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py gl_e.asm -o gl_e.bin --base 0x6300 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py gl_2.asm -o gl_2.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    gl.img gl_a.bin --name /bin/gla.bin --load 0x6300 --exec 0x6300 >/dev/null
python3 $ROOT/tools/p8xfs.py put    gl.img gl_b.bin --name /bin/glb.bin --load 0x6300 --exec 0x6300 >/dev/null
python3 $ROOT/tools/p8xfs.py put    gl.img gl_e.bin --name /bin/gle.bin --load 0x6300 --exec 0x6300 >/dev/null
python3 $ROOT/tools/p8xfs.py put    gl.img gl_2.bin --name /bin/gl2.bin --load 0x6300 --exec 0x6300 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py gl_f.asm -o gl_f.bin --base 0x6300 >/dev/null
python3 $ROOT/tools/p8xfs.py put gl.img gl_f.bin --name /bin/glf.bin --load 0x6300 --exec 0x6300 >/dev/null
