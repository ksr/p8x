...
python3 $ROOT/assembler/p8xasm.py aofull.asm -o asmgold.bin --base 0x6100 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    ao.img asmgold.bin --name ASM.bin --load 0x6100 --exec 0x6100 >/dev/null
