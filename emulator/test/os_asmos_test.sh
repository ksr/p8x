...
python3 $ROOT/assembler/p8xasm.py aofull.asm -o asmgold.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    ao.img asmgold.bin --name ASM.bin --load 0x5900 --exec 0x5900 >/dev/null
