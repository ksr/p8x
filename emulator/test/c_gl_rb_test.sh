...
python3 $ROOT/assembler/p8xasm.py gl_rb.asm -o gl_rb.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    gl_rb.img gl_rb.bin --name /bin/glrb.bin --load 0x5900 --exec 0x5900 >/dev/null
