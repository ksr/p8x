...
python3 $ROOT/assembler/p8xasm.py gl_ar.asm -o gl_ar.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    gl_ar.img gl_ar.bin --name /bin/glar.bin --load 0x6300 --exec 0x6300 >/dev/null
