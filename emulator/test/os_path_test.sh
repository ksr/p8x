...
python3 $ROOT/assembler/p8xasm.py g.asm -o g.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    path.img g.bin --name /bin/greet.bin --load 0x6300 --exec 0x6300 >/dev/null
