...
python3 $ROOT/assembler/p8xasm.py g.asm -o g.bin --base 0x6100 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    path.img g.bin --name /bin/greet.bin --load 0x6100 --exec 0x6100 >/dev/null
