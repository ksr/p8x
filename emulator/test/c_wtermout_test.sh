...
build() { python3 $ROOT/tools/clib.py "$1" -o t.pp.c && python3 $ROOT/compiler/p8cc.py t.pp.c -o t.asm >/dev/null && python3 $ROOT/assembler/p8xasm.py t.asm -o "$2" --base 0x6300 >/dev/null; }
...
python3 $ROOT/tools/p8xfs.py put    wto.img wto_wd.bin  --name /bin/wdesk.bin --load 0x6300 --exec 0x6300 >/dev/null
python3 $ROOT/tools/p8xfs.py put    wto.img wto_pwd.bin --name /bin/pwd.bin   --load 0x6300 --exec 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    wtob.img wto_wd.bin  --name /bin/wdesk.bin --load 0x6300 --exec 0x6300 >/dev/null
python3 $ROOT/tools/p8xfs.py put    wtob.img wto_pwd.bin --name /bin/pwd.bin   --load 0x6300 --exec 0x6300 >/dev/null
