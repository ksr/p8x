...
for c in finder image paint; do
    ...
    python3 $ROOT/assembler/p8xasm.py $c.a.asm -o $c.a.bin --base 0x5900 >/dev/null
done
...
python3 $ROOT/tools/p8xfs.py put    i.img finder.a.bin --name /bin/finder.bin --load 0x5900 --exec 0x5900 >/dev/null
python3 $ROOT/tools/p8xfs.py put    i.img image.a.bin  --name /bin/image.bin  --load 0x5900 --exec 0x5900 >/dev/null
python3 $ROOT/tools/p8xfs.py put    i.img paint.a.bin  --name /bin/paint.bin  --load 0x5900 --exec 0x5900 >/dev/null
