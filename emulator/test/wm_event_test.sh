...
python3 $ROOT/assembler/p8xasm.py ep_run.asm -o ep_run.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    ep.img ep_run.bin --name /bin/ep.bin --load 0x6300 --exec 0x6300 >/dev/null
