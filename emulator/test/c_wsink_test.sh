...
python3 $ROOT/assembler/p8xasm.py ws_probe.asm -o ws_probe.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    ws.img ws_probe.bin --name /bin/sink.bin --load 0x6300 --exec 0x6300 >/dev/null
