...
python3 $ROOT/assembler/p8xasm.py sc.asm -o sc.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    gt.img sc.bin --name /bin/screen.bin --load 0x6300 --exec 0x6300 >/dev/null
