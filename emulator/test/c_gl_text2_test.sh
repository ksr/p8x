...
python3 $ROOT/tools/p8xfs.py put    gl_t2.img gl_t2.bin --name /bin/glt2.bin --load 0x5900 --exec 0x5900 >/dev/null
...
printf "E ${GCONEN}\r00.G 014E\rB\rrun /bin/glt2.bin\r" > gl_t2.in
