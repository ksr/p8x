...
python3 $ROOT/assembler/p8xasm.py gl_t2.asm -o gl_t2.bin --base 0x6100 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    gl_t2.img gl_t2.bin --name /bin/glt2.bin --load 0x6100 --exec 0x6100 >/dev/null
