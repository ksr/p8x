...
python3 $ROOT/assembler/p8xasm.py c_stub.asm -o c_stub.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    a.img fnd.bin --name /bin/finder.bin --load 0x5900 --exec 0x5900 >/dev/null
python3 $ROOT/tools/p8xfs.py put    a.img c_stub.bin --name /bin/cube.bin --load 0x5900 --exec 0x5900 >/dev/null
