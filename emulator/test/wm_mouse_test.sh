...
python3 $ROOT/assembler/p8xasm.py ms_run.asm -o ms_run.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    ms.img ms_run.bin --name /bin/ms.bin --load 0x6300 --exec 0x6300 >/dev/null
