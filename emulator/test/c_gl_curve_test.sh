...
python3 $ROOT/assembler/p8xasm.py gl_cv.asm -o gl_cv.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    gl_cv.img gl_cv.bin --name /bin/glcv.bin --load 0x6300 --exec 0x6300 >/dev/null
