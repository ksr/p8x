...
for n in 1 2 3 4; do
    ...
    python3 $ROOT/assembler/p8xasm.py gl_as$n.asm -o gl_as$n.bin --base 0x5900 >/dev/null
done
rm -f gla.img
...
for n in 1 2 3 4; do
    python3 $ROOT/tools/p8xfs.py put gla.img gl_as$n.bin --name /bin/as$n.bin --load 0x5900 --exec 0x5900 >/dev/null
done
