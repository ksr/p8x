...
python3 $ROOT/assembler/p8xasm.py md_t.asm -o md_t.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    md.img md_t.bin --name /bin/md.bin --load 0x6300 --exec 0x6300 >/dev/null
