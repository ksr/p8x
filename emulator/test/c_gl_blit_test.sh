...
python3 $ROOT/assembler/p8xasm.py gl_bl.asm -o gl_bl.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    gl_bl.img gl_bl.bin --name /bin/glbl.bin --load 0x6300 --exec 0x6300 >/dev/null
