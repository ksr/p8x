...
for c in awk cat; do
    ...
    python3 $ROOT/assembler/p8xasm.py $c.a2.asm -o $c.a2.bin --base 0x5900 >/dev/null
done
rm -f awk.img
...
python3 $ROOT/tools/p8xfs.py put    awk.img awk.a2.bin --name /bin/awk.bin --load 0x5900 --exec 0x5900 >/dev/null
python3 $ROOT/tools/p8xfs.py put    awk.img cat.a2.bin --name /bin/cat.bin --load 0x5900 --exec 0x5900 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py awk.a.asm -o awk.a.bin --base 0x5900 >/dev/null
rm -f awka.img
...
python3 $ROOT/tools/p8xfs.py put    awka.img awk.a.bin --name /bin/awk.bin --load 0x5900 --exec 0x5900 >/dev/null
python3 $ROOT/tools/p8xfs.py put    awka.img cat.a2.bin --name /bin/cat.bin --load 0x5900 --exec 0x5900 >/dev/null
