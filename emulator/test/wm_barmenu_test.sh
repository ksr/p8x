...
python3 $ROOT/assembler/p8xasm.py bm_run.asm -o bm_run.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    bm.img bm_run.bin --name /bin/bm.bin --load 0x5900 --exec 0x5900 >/dev/null
