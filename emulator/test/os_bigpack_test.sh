...
python3 $ROOT/assembler/p8xasm.py bpdir.asm -o bpdir.bin --base 0x6100 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    bp.img bpdir.bin --name /bin/dir.bin --load 0x6100 --exec 0x6100 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py bpdep.asm -o bpdep.bin --base 0x6100 >/dev/null
python3 $ROOT/tools/p8xfs.py put    bp.img bpdep.bin --name /bin/dep.bin --load 0x6100 --exec 0x6100 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py bpdel.asm -o bpdel.bin --base 0x6100 >/dev/null
python3 $ROOT/tools/p8xfs.py put    bp.img bpdel.bin --name /bin/del.bin --load 0x6100 --exec 0x6100 >/dev/null
