...
python3 $ROOT/assembler/p8xasm.py bpdir.asm -o bpdir.bin --base 0x6A00 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    bp.img bpdir.bin --name /bin/dir.bin --load 0x6A00 --exec 0x6A00 >/dev/null
