...
python3 $ROOT/assembler/p8xasm.py cr_cp.asm -o cr_cp.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put cr0.img cr_cp.bin --name /bin/cp.bin --load 0x6300 --exec 0x6300 >/dev/null
