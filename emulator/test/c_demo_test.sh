...
for p in cube tri rotate page camera gl md house clsave image; do
...
echo "all ten clients compile and fit below CSTACKTOP"
...
echo "C-DEMO TEST: PASS (ten clients fit under CSTACKTOP; house/tri/camera/rotate/page draw and exit clean)"
