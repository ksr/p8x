...
python3 $ROOT/assembler/p8xasm.py cp_paint.asm -o cp_paint.bin --base 0x6100 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    cp.img cp_paint.bin --name /bin/paint.bin --load 0x6100 --exec 0x6100 >/dev/null
