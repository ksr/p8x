...
python3 $ROOT/assembler/p8xasm.py gl_tx.asm -o gl_tx.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    gl_tx.img gl_tx.bin --name /bin/gltx.bin --load 0x6300 --exec 0x6300 >/dev/null
