...
python3 $ROOT/assembler/p8xasm.py ci_image.asm -o ci_image.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    ci.img ci_image.bin --name /bin/image.bin --load 0x6300 --exec 0x6300 >/dev/null
...
python3 $ROOT/assembler/p8xasm.py ci_image_a.asm -o ci_image_a.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    cia.img ci_image_a.bin --name /bin/image.bin --load 0x6300 --exec 0x6300 >/dev/null
