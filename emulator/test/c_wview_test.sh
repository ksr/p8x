...
python3 $ROOT/assembler/p8xasm.py wv_wdesk.asm -o wv_wdesk.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    wv.img wv_wdesk.bin --name /bin/wdesk.bin --load 0x6300 --exec 0x6300 >/dev/null
