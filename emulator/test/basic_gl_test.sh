...
assert px[(204*480+364)*3:(204*480+364)*3+3]==b"\xff\x00\x00", "pixel not red"
EOF
echo "BASIC-GL TEST: PASS (GL statement + native verbs + recorded-list rotation + COLOR bridge + POINT)"
