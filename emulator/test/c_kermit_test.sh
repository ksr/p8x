...
python3 $ROOT/assembler/p8xasm.py km.asm -o km.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    k.img km.bin   --name /bin/kermit.bin --load 0x5900 --exec 0x5900 >/dev/null
