...
python3 $ROOT/assembler/p8xasm.py km.asm -o km.bin --base 0x6100 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    k.img km.bin   --name /bin/kermit.bin --load 0x6100 --exec 0x6100 >/dev/null
