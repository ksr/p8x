...
python3 $ROOT/assembler/p8xasm.py fc_run.asm -o fc_run.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    fc.img fc_run.bin --name /bin/fc.bin --load 0x5900 --exec 0x5900 >/dev/null
