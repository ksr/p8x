...
python3 $ROOT/assembler/p8xasm.py greetp.asm -o greetp.bin --base 0x6300 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    pc.img greetp.bin --name /UTIL/greet.bin --load 0x6300 --exec 0x6300 >/dev/null
