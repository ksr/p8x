...
python3 $ROOT/assembler/p8xasm.py greetp.asm -o greetp.bin --base 0x6A00 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    pc.img greetp.bin --name /UTIL/greet.bin --load 0x6A00 --exec 0x6A00 >/dev/null
