...
python3 $ROOT/assembler/p8xasm.py del.asm -o del.bin --base 0x5900 >/dev/null
...
python3 $ROOT/tools/p8xfs.py put    dlt.img del.bin --name /bin/del.bin --load 0x5900 --exec 0x5900 >/dev/null
printf 'x\n' > f.txt
