...
MAP = [
    ...
    ('memory-region anchors', 'TPABASE', 0x6300, 'transient program area base (RUNnable programs load here)'),
    ...
    ('OS scratch ($5900-$5FFF)', 'LINEBUF', 0x5900, 'shell input line (64 bytes)'),
    ('OS scratch ($5900-$5FFF)', 'CMDBUF', 0x5940, 'parsed command word (16 bytes)'),
    ('OS scratch ($5900-$5FFF)', 'NAMEBUF', 0x5950, '12-byte filename (search key / DIR scratch)'),
    ('OS scratch ($5900-$5FFF)', 'ECNT', 0x5963, 'entries-left-in-sector counter'),
    ('OS scratch ($5900-$5FFF)', 'FLAGS', 0x5964, 'current entry flag byte'),
    ('OS scratch ($5900-$5FFF)', 'MATCH', 0x5965, '1 = name matched / strings equal'),
    ('OS scratch ($5900-$5FFF)', 'LENLO', 0x5966, 'entry length, low 16 bits'),
    ('OS scratch ($5900-$5FFF)', 'LENHI', 0x5967, ''),
    ('OS scratch ($5900-$5FFF)', 'STARTLO', 0x5968, 'entry start LBA (low byte)'),
    ('OS scratch ($5900-$5FFF)', 'LOADLO', 0x5969, 'entry load address'),
    ('OS scratch ($5900-$5FFF)', 'LOADHI', 0x596A, ''),
    ('OS scratch ($5900-$5FFF)', 'EXECLO', 0x596B, 'entry exec address'),
    ('OS scratch ($5900-$5FFF)', 'EXECHI', 0x596C, ''),
    ('OS scratch ($5900-$5FFF)', 'DLBA', 0x596D, 'directory sector being scanned'),
    ('OS scratch ($5900-$5FFF)', 'SECCNT', 0x596E, 'sectors left to transfer'),
    ('OS scratch ($5900-$5FFF)', 'CURLBA', 0x596F, 'current data LBA'),
    ('OS scratch ($5900-$5FFF)', 'ENTPL', 0x5970, 'pointer to a directory entry (in SBUF):'),
    ('OS scratch ($5900-$5FFF)', 'ENTPH', 0x5971, 'flag byte for DEL, entry start for SAVE'),
    ('OS scratch ($5900-$5FFF)', 'ARGPL', 0x5972, 'saved arg position in LINEBUF'),
    ('OS scratch ($5900-$5FFF)', 'ARGPH', 0x5973, ''),
    ('OS scratch ($5900-$5FFF)', 'HXLO', 0x5974, 'GETHEX result'),
    ('OS scratch ($5900-$5FFF)', 'HXHI', 0x5975, ''),
    ('OS scratch ($5900-$5FFF)', 'DIGIT', 0x5976, 'HEXVAL digit value'),
    ('OS scratch ($5900-$5FFF)', 'SHCNT', 0x5977, 'shift counter'),
    ('OS scratch ($5900-$5FFF)', 'SVSTLO', 0x5978, 'SAVE source start address'),
    ('OS scratch ($5900-$5FFF)', 'SVSTHI', 0x5979, ''),
    ('OS scratch ($5900-$5FFF)', 'FREELO', 0x597A, 'boot-block free pointer (next data LBA)'),
    ('OS scratch ($5900-$5FFF)', 'FREEHI', 0x597B, ''),
    ('OS scratch ($5900-$5FFF)', 'SRCLO', 0x597C, 'running source pointer during the copy'),
    ('OS scratch ($5900-$5FFF)', 'SRCHI', 0x597D, ''),
    ('OS scratch ($5900-$5FFF)', 'REM', 0x597E, 'sectors remaining in the SAVE write loop'),
    ('OS scratch ($5900-$5FFF)', 'NF', 0x5980, 'running next-free LBA'),
    ('OS scratch ($5900-$5FFF)', 'PFOUND', 0x5981, '1 if this pass found an unpacked extent'),
    ('OS scratch ($5900-$5FFF)', 'MINSTRT', 0x5982, 'smallest start LBA >= NF this pass'),
    ('OS scratch ($5900-$5FFF)', 'MINSEC', 0x5983, "that extent's sector count"),
    ('OS scratch ($5900-$5FFF)', 'MINPL', 0x5984, "pointer to that entry's start-LBA field (in SBUF)"),
    ('OS scratch ($5900-$5FFF)', 'MINPH', 0x5985, ''),
    ('OS scratch ($5900-$5FFF)', 'MINDL', 0x5986, "that entry's directory sector LBA"),
    ('OS scratch ($5900-$5FFF)', 'ESTART', 0x5987, 'current entry start LBA (low byte)'),
    ('OS scratch ($5900-$5FFF)', 'SRCL', 0x5988, 'copy source LBA'),
    ('OS scratch ($5900-$5FFF)', 'DSTL', 0x5989, 'copy dest LBA'),
    ('OS scratch ($5900-$5FFF)', 'CPYN', 0x598A, 'sectors left to copy'),
    ('OS scratch ($5900-$5FFF)', 'CANDL', 0x598B, "current entry's start-field pointer"),
    ('OS scratch ($5900-$5FFF)', 'CANDH', 0x598C, ''),
    ('OS scratch ($5900-$5FFF)', 'ROOTN', 0x598D, 'root directory sector count (4)'),
    ('OS scratch ($5900-$5FFF)', 'DATABASE', 0x598E, 'first data LBA (37)'),
    ('OS scratch ($5900-$5FFF)', 'CWDL', 0x598F, 'current directory: start LBA'),
    ('OS scratch ($5900-$5FFF)', 'CWDN', 0x5990, 'sector count'),
    ('OS scratch ($5900-$5FFF)', 'SDIRL', 0x5991, 'directory being scanned this op (start LBA)'),
    ('OS scratch ($5900-$5FFF)', 'SDIRN', 0x5992, 'sector count'),
    ('OS scratch ($5900-$5FFF)', 'SCNT', 0x5993, 'sectors-left counter while scanning a directory'),
    ('OS scratch ($5900-$5FFF)', 'LSL', 0x5994, "SETPATH: pointer to the last '/' in CWDPATH"),
    ('OS scratch ($5900-$5FFF)', 'LSH', 0x5995, ''),
    ('OS scratch ($5900-$5FFF)', 'PATHL', 0x5996, 'saved path cursor across DESCEND (FINDENT clobbers P2)'),
    ('OS scratch ($5900-$5FFF)', 'PATHH', 0x5997, ''),
    ('OS scratch ($5900-$5FFF)', 'NEWLBA', 0x5998, 'MKDIR: LBA of the new directory extent'),
    ('OS scratch ($5900-$5FFF)', 'PSL', 0x5999, 'MKDIR: parent dir start LBA / sector count'),
    ('OS scratch ($5900-$5FFF)', 'PSN', 0x599A, ''),
    ('OS scratch ($5900-$5FFF)', 'EFLAG', 0x599B, 'flag byte WRENT stamps (F_FILE for SAVE, F_DIR for MKDIR)'),
    ('OS scratch ($5900-$5FFF)', 'RMDL', 0x599C, 'RMDIR: parent directory sector holding the entry'),
    ('OS scratch ($5900-$5FFF)', 'CDST', 0x599D, 'current directory: start LBA / sectors / entry index'),
    ('OS scratch ($5900-$5FFF)', 'CDSC', 0x599E, ''),
    ('OS scratch ($5900-$5FFF)', 'CIDX', 0x599F, ''),
    ('OS scratch ($5900-$5FFF)', 'REDIRF', 0x59A0, '0 = console, 1 = capturing to RBUF'),
    ('OS scratch ($5900-$5FFF)', 'RCH', 0x59A1, 'OUTCH: byte being emitted'),
    ('OS scratch ($5900-$5FFF)', 'RS2L', 0x59A2, 'OUTCH: saved caller P2'),
    ('OS scratch ($5900-$5FFF)', 'RS2H', 0x59A3, ''),
    ('OS scratch ($5900-$5FFF)', 'RPTRL', 0x59A4, 'OUTCH: next free byte in the capture buffer'),
    ('OS scratch ($5900-$5FFF)', 'RPTRH', 0x59A5, ''),
    ('OS scratch ($5900-$5FFF)', 'RHX', 0x59A6, 'OPHEX8 scratch'),
    ('OS scratch ($5900-$5FFF)', 'REDNAME', 0x59A7, 'redirect target filename (null-terminated, <=48): $63A7..$63D6'),
    ('OS scratch ($5900-$5FFF)', 'FNDIR', 0x59D7, 'directories counted'),
    ('OS scratch ($5900-$5FFF)', 'FNFIL', 0x59D8, 'files counted'),
    ('OS scratch ($5900-$5FFF)', 'FNDEL', 0x59D9, 'deleted slots counted'),
    ('OS scratch ($5900-$5FFF)', 'FMAXE', 0x59DA, 'highest extent end LBA seen (data area only)'),
    ('OS scratch ($5900-$5FFF)', 'FUSED', 0x59DB, 'data sectors occupied by live extents'),
    ('OS scratch ($5900-$5FFF)', 'FERR', 0x59DC, 'problems found (0 = clean)'),
    ('OS scratch ($5900-$5FFF)', 'FCHILD', 0x59DD, "CHKDD: directory whose '..' is being checked"),
    ('OS scratch ($5900-$5FFF)', 'FEXP', 0x59DE, 'CHKDD: expected parent LBA'),
    ('TPA (transient programs)', 'RBUF', 0x6300, 'capture buffer = the TPA (free during a built-in cmd)'),
    ('OS scratch ($5900-$5FFF)', 'TSP', 0x59E0, 'tree stack depth (0 = at root level)'),
    ('OS scratch ($5900-$5FFF)', 'TI', 0x59E1, 'scratch loop counter for the frame stack'),
    ('OS scratch ($5900-$5FFF)', 'LENHI2', 0x59E2, 'entry length, bits 16..23 (the BIOS FLEN 3rd byte)'),
    ('OS scratch ($5900-$5FFF)', 'SECCH', 0x59E3, 'SECCOUNT sector-count high byte (files >255 sectors)'),
    ('OS scratch ($5900-$5FFF)', 'MINSECH', 0x59E4, "PACK: chosen extent's sector count, high byte"),
    ('OS scratch ($5900-$5FFF)', 'CPYNH', 0x59E5, 'PK2MOVE: sectors-to-copy counter, high byte'),
    ('OS scratch ($5900-$5FFF)', 'TFRAME', 0x5AB7, '8 frames x 4 bytes (dst_lo,dst_hi,dsc,idx): $64B7..$64D6'),
    ('OS scratch ($5900-$5FFF)', 'PPSEC', 0x59FA, "chosen extent's parent-entry: dir sector LBA / slot"),
    ('OS scratch ($5900-$5FFF)', 'PPSLOT', 0x59FB, ''),
    ('OS scratch ($5900-$5FFF)', 'CANDSEC', 0x59FC, "candidate entry's location during the find walk"),
    ('OS scratch ($5900-$5FFF)', 'CANDSLOT', 0x59FD, ''),
    ('OS scratch ($5900-$5FFF)', 'PARST', 0x59FE, "PK2FIX: parent directory start LBA (for '..')"),
    ('OS scratch ($5900-$5FFF)', 'CWDPATH', 0x5A00, 'textual CWD path for the prompt (up to 48 bytes)'),
    ('OS scratch ($5900-$5FFF)', 'INMODE', 0x5A30, 'SYS_GETC source: 0 = console, 1 = the read stream'),
    ('OS scratch ($5900-$5FFF)', 'INARM', 0x5A31, "shell armed a '< file' for the next RUN"),
    ('OS scratch ($5900-$5FFF)', 'INNAME', 0x5A32, "'< file' name (null-terminated, <=48): $6432..$6461"),
    ('OS scratch ($5900-$5FFF)', 'PIPEF', 0x5A62, 'pipe stage: 0 none, 1 left ran, 2 right ran'),
    ('OS scratch ($5900-$5FFF)', 'PIPEBUF', 0x5A63, "saved right-hand command of a 'cmd | cmd' ($6463..$64A2)"),
    ('OS scratch ($5900-$5FFF)', 'CWDLH', 0x5AA3, 'CWDL high byte (current working directory start LBA)'),
    ('OS scratch ($5900-$5FFF)', 'SDIRLH', 0x5AA4, 'SDIRL high byte (directory being scanned this op)'),
    ('OS scratch ($5900-$5FFF)', 'STARTHI', 0x5AA5, 'STARTLO high byte (entry start LBA from FINDENT)'),
    ('OS scratch ($5900-$5FFF)', 'DLBAH', 0x5AA6, 'DLBA high byte (directory-sector scan cursor)'),
    ('OS scratch ($5900-$5FFF)', 'NEWLBAH', 0x5AA7, 'NEWLBA high byte (MKDIR new extent)'),
    ('OS scratch ($5900-$5FFF)', 'PSLH', 0x5AA8, 'PSL high byte (MKDIR parent extent)'),
    ('OS scratch ($5900-$5FFF)', 'PARSTH', 0x5AA9, "PARST high byte (PACK '..' parent fix)"),
    ('OS scratch ($5900-$5FFF)', 'RMDLH', 0x5AAA, 'RMDL high byte (RMDIR parent sector)'),
    ('OS scratch ($5900-$5FFF)', 'CURLBAH', 0x5AAB, 'CURLBA high byte (SAVE data-write LBA, 16-bit)'),
    ('OS scratch ($5900-$5FFF)', 'NFH', 0x5AAC, 'NF high byte (PACK next-free target)'),
    ('OS scratch ($5900-$5FFF)', 'MINSTRTH', 0x5AAD, 'MINSTRT high byte (smallest start LBA this pass)'),
    ('OS scratch ($5900-$5FFF)', 'CDSTH', 0x5AAE, 'CDST high byte (current directory in the walk)'),
    ('OS scratch ($5900-$5FFF)', 'CANDSECH', 0x5AAF, "CANDSEC high byte (candidate entry's dir sector)"),
    ('OS scratch ($5900-$5FFF)', 'PPSECH', 0x5AB0, "PPSEC high byte (chosen extent's parent-entry sector)"),
    ('OS scratch ($5900-$5FFF)', 'SRCH', 0x5AB1, 'SRCL high byte (PK2MOVE copy source)'),
    ('OS scratch ($5900-$5FFF)', 'DSTH', 0x5AB2, 'DSTL high byte (PK2MOVE copy dest)'),
    ('OS scratch ($5900-$5FFF)', 'FCHILDH', 0x5AB3, 'FCHILD high byte (CHKDD child dir)'),
    ('OS scratch ($5900-$5FFF)', 'FEXPH', 0x5AB4, 'FEXP high byte (CHKDD expected parent)'),
    ('OS scratch ($5900-$5FFF)', 'FMAXEH', 0x5AB5, 'FMAXE high byte (FSCK highest extent end)'),
    ('OS scratch ($5900-$5FFF)', 'FUSEDH', 0x5AB6, 'FUSED high byte (FSCK live data sectors)'),
    ('OS scratch ($5900-$5FFF)', 'REDAPP', 0x5AD7, '>> append redirect: 1 = prepend the existing file'),
    ('OS scratch ($5900-$5FFF)', 'APHAVE', 0x5AD8, '>> : 1 = an existing file to prepend was found'),
    ('OS scratch ($5900-$5FFF)', 'APLBA', 0x5AD9, ">> : old file's start LBA (2 bytes)"),
    ('OS scratch ($5900-$5FFF)', 'APREM', 0x5ADB, '>> : old file bytes left to copy (2 bytes)'),
    ('OS scratch ($5900-$5FFF)', 'APCHK', 0x5ADD, '>> : bytes to emit from the current sector (2 bytes)'),
    ('OS scratch ($5900-$5FFF)', 'SCRIPTM', 0x5AE0, '1 = the shell is running lines from a `sh` script'),
    ('OS scratch ($5900-$5FFF)', 'SCRSAVE', 0x5AE1, 'saved script read-stream state (ROSTATE 13 + ROSDRV = 14: $64E1..$64EE)'),
    ('OS scratch ($5900-$5FFF)', 'SCRCNT', 0x5AEF, 'byte counter for SAVESCR/RESTSCR (1)'),
    ('OS scratch ($5900-$5FFF)', 'APBUF', 0x5E00, '>> prepend sector buffer (512B, below the TPA); also the'),
    ('OS scratch ($5900-$5FFF)', 'IBUF', 0x5B00, '512-byte buffer for the stdin read stream'),
    ('OS scratch ($5900-$5FFF)', 'PATHBUF', 0x5D00, "search path, ';'-separated dirs; default '/BIN' ($6700..$673F)"),
    ('OS scratch ($5900-$5FFF)', 'RUNPATH', 0x5D40, 'scratch: candidate program path built during a lookup ($6740..$679F)'),
    ('OS scratch ($5900-$5FFF)', 'RUNSKIP', 0x5DA0, 'DORUN: 1 = skip the program-name word for the arg pointer'),
    ('OS scratch ($5900-$5FFF)', 'PSCANL', 0x5DA1, 'PATH search cursor into PATHBUF (low)'),
    ('OS scratch ($5900-$5FFF)', 'PSCANH', 0x5DA2, 'PATH search cursor into PATHBUF (high)'),
    ('OS scratch ($5900-$5FFF)', 'GPLF', 0x5DA3, 'SYS_GETC console: 1 = a LF is pending after a CR keypress'),
    ('OS scratch ($5900-$5FFF)', 'CURDRIVE', 0x5DA4, 'derived: 1 if the CWD is under /d1 (drive 1), else 0'),
    ('OS scratch ($5900-$5FFF)', 'DRVINIT', 0x5DA5, "bitmask: bit N set = drive N has been CFINIT'd this session"),
    ('OS scratch ($5900-$5FFF)', 'MPSAV', 0x5DA6, "MNTPFX: saved P2 (2 bytes) while sniffing a 'd1' prefix"),
    ...
    ('shell completion', 'CMPPFX', 0x5E00, 'tab-complete: leaf prefix being completed (NUL-term, 64; aliases APBUF)'),
    ('shell completion', 'CMPLCP', 0x5E40, 'tab-complete: longest common prefix of the matches (NUL-term, 16; aliases APBUF)'),
    ('shell completion', 'CMPDIR', 0x5E50, 'tab-complete: directory-part path string, for CDPATH (NUL-term, 64; aliases APBUF)'),
