...
/* shell completion */
#define CMPPFX      0x5F70       /* tab-complete: leaf prefix being completed (NUL-term, 64) */
#define CMPLCP      0x5FB0       /* tab-complete: longest common prefix of the matches (NUL-term, 16) */
#define CMPDIR      0x5FC0       /* tab-complete: directory-part path string, for CDPATH (NUL-term, 64) */
