...
#define CMPLCP      0x5F40       /* tab-complete: longest common prefix of the matches (NUL-term) */
#define CMPDIR      0x5F60       /* tab-complete: directory-part path string, for CDPATH (NUL-term) */
