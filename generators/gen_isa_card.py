...
DESC = {
    ...
    ("ADDW", "a,#"): ("CZNV", "word a:=a+imm8 (zero-ext), 16-bit; C=carry out. A!"),
    ("SUBW", "a,#"): ("CZNV", "word a:=a-imm8; C=1 no borrow. A!"),
    ("CMPW", "a,#"): ("CZNV", "flags from a-imm8 (16-bit), memory unchanged. A!"),
