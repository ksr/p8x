...
; =============================================================================
; Built for the transient program area ($5900), launched from P8X/OS:
;     RUN EDIT NAME.EXT
...
LBA     = $1F47         ; 24-bit LBA (lo/mid/hi)
LBA1    = $1F48
LBA2    = $1F49
FNAME   = $1F4A         ; 12-byte space-padded name
FSRC    = $1F56         ; FCREATE source address
FLEN    = $1F58         ; length (FCREATE in / FFIND out)
