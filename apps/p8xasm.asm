...
; Output carries load/exec 0, which the OS treats as the TPA base $6300 -- so a
; program written `.org $6300` is directly RUNnable after assembly.
;
...
;   $6300-$7FFF code + opcode table       $C900-$CAFF SECBUF (source sector)
