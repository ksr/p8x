...
program area (`$6300`), so a compiled program is a RUNnable `.BIN`.

```sh
python3 compiler/p8cc.py prog.c -o prog.asm
python3 assembler/p8xasm.py prog.asm -o prog.bin --base 0x6300
python3 tools/p8xfs.py put disk.img prog.bin --name /PROG.BIN --load 0x6300 --exec 0x6300
