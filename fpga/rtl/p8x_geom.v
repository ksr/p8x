...
module p8x_geom (
  ...
  initial begin                      // power-on: both masters identity
    ...
    cmx[609] = 16'hFFFF;            // COLOR: white pen
    cmx[610] = 16'hFFFF;            // PROJCT: native focal
    cmx[620] = 16'd16;              // near plane
    cmx[621] = 16'd32767;           // far: disabled
...
`include "glkwtab.vh"
  ...
  // stage 10e: FLAGRD's state mirror, above the keyword ROM (ends ~601).
  ...
  always @(*) begin
    ...
    case (srcb)
      ...
      8'hE0,8'hAA,8'hAB,8'h70,8'h72,8'h74,8'h79,
