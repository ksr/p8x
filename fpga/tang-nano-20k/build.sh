...
case "$TARGET" in
  ...
  cpu)  SRC="../rtl/p8x_cpu.v ../rtl/p8x_mdu.v ../rtl/mdu_core.v rtl/p8x_top.v rtl/uart.v rtl/cf_sd.v rtl/sd_spi.v"; TOP=p8x_top;  FS=p8x_cpu.fs ;;
  ...
  lcd)  SRC="../rtl/p8x_cpu.v ../rtl/gfx.v ../rtl/p8x_mdu.v ../rtl/mdu_core.v ../rtl/p8x_geom.v ../rtl/trigtab.v rtl/p8x_top.v rtl/uart.v rtl/cf_sd.v rtl/sd_spi.v sdram/p8x_sdram.v sdram/sdram_arb.v sdram/gfx_mem.v sdram/gfx_span.v sdram/sdram_video.v ../rtl/gtxt.v"; TOP=p8x_top; FS=p8x_lcd.fs; YOSYS_DEFS="-DLCD" ;;
  ...
  card) SRC="../rtl/p8x_bridge.v ../rtl/gfx.v ../rtl/mdu_core.v ../rtl/p8x_geom.v ../rtl/trigtab.v rtl/p8x_gcard_top.v rtl/uart.v sdram/p8x_sdram.v sdram/sdram_arb.v sdram/gfx_mem.v sdram/gfx_span.v sdram/sdram_video.v ../rtl/gtxt.v"; TOP=p8x_gcard_top; FS=p8x_card.fs; YOSYS_DEFS="-DLCD" ;;
