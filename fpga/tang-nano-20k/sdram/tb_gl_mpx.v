// tb_gl_mpx.v -- the stage-10b MATRIX scene through the REAL pixel stack.
...
module tb;
  ...
  initial begin
    ...
    // ---- the GL scene: byte for byte what c_gl_mat_test's gl_m.c pokes ---
    glb(8'hB3); glw(-16'sd120); glw(16'sd120); glw(-16'sd120); glw(16'sd120);
    glb(8'hB2); glw(16'sd104); glw(16'sd375); glw(16'sd0); glw(16'sd271);
    glb(8'h07); glb(8'd0); glb(8'd0); glb(8'd0);
    glb(8'h06); glb(8'd31); glb(8'd63); glb(8'd31);
    glb(8'h96); glw(16'sd0); glw(16'sd0); glw(16'sd400);        // MDTRAN
    glb(8'h12); glw(16'sd60); glw(16'sd0); glw(16'sd0); glb(8'h09);
    glb(8'h06); glb(8'd31); glb(8'd0); glb(8'd0);
    glb(8'h90);                                                 // MDIDEN
    glb(8'h96); glw(16'sd0); glw(16'sd0); glw(16'sd400);
    glb(8'h91); glw(16'sd0); glw(16'sd0); glw(16'sd400);        // MDORG
    glb(8'h94); glw(16'sd90);                                   // MDROTY
    glb(8'h12); glw(16'sd60); glw(16'sd0); glw(16'sd0); glb(8'h09);
    glb(8'h06); glb(8'd0); glb(8'd63); glb(8'd0);
    glb(8'h90);                                                 // MDIDEN
    glb(8'hA0);                                                 // VWIDEN
    glb(8'hA1); glw(16'sd0); glw(16'sd0); glw(16'sd400);        // VWRPT
    glb(8'hA4); glw(16'sd90);                                   // VWROTY
    glb(8'hB1); glw(16'sd500);                                  // DISTAN
    glb(8'h12); glw(16'sd60); glw(16'sd30); glw(16'sd400); glb(8'h09);
    glb(8'h06); glb(8'd0); glb(8'd0); glb(8'd31);
    glb(8'hA0); glb(8'hA1); glw(16'sd0); glw(16'sd0); glw(16'sd0);
    glb(8'hB0); glw(16'sd60);                                   // PROJCT
    glb(8'h12); glw(16'sd0); glw(16'sd50); glw(16'sd0); glb(8'h09);
    glb(8'h06); glb(8'd31); glb(8'd63); glb(8'd0);
    glb(8'h04);                                                 // RESETF
    glb(8'hB3); glw(-16'sd120); glw(16'sd120); glw(-16'sd120); glw(16'sd120);
    glb(8'hB2); glw(16'sd104); glw(16'sd375); glw(16'sd0); glw(16'sd271);
    glb(8'h06); glb(8'd31); glb(8'd63); glb(8'd0);
    glb(8'hAB); glb(8'd1); glb(8'hA9); glw(16'sd600);           // CLIPY,DISTY
    glb(8'h12); glw(-16'sd80); glw(-16'sd60); glw(16'sd300);
    glb(8'h2A); glw(16'sd320); glw(-16'sd60); glw(16'sd2300);
    glb(8'h06); glb(8'd0); glb(8'd63); glb(8'd31);
    glb(8'hAB); glb(8'd0);                                      // CLIPY off
    glb(8'h12); glw(-16'sd70); glw(16'sd80); glw(16'sd500);
    glb(8'hAF);                                                 // CONVRT
    glb(8'h08);                                                 // POINT
    gl_wait_idle;

    if (CHIP.protocol_errors != 0) begin
      $display("TB-GL-MPX: FAIL (%0d protocol errors)", CHIP.protocol_errors);
      $finish(1);
    end

    // ---- dump page 0 as a P6 PPM, the emulator's exact format -------------
    f = $fopen("tb_gl_mpx.ppm", "wb");
    $fwrite(f, "P6\n480 272\n255\n");
    for (y = 0; y < 272; y = y + 1)
    ...
    $fclose(f);
    $display("TB-GL-MPX: DONE (tb_gl_mpx.ppm written; compare against the emulator)");
    $finish(0);
  end

  initial begin #400_000_000; $display("TB-GL-MPX: TIMEOUT"); $finish(1); end
endmodule
