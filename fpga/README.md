...
| **6** | Graphics: 480x272 panel + drawing engine ✅ | yes | BASIC draws on a real panel. The engine/emulator frame diff (`sim/gfx.sh`) is **red** — two commands missing in RTL, see BACKLOG |
