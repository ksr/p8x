...
| **SCREEN mode** | Which geometry and depth the display is in. Mode 0 is 240×136 at 2 bpp (4 pens) and is the power-on default; mode 1 is 480×272 at 8 bpp (256 pens) and needs an SDRAM framebuffer on hardware. Selected by `GCMD $0C` SETMODE with the mode in `GPARM`. |
