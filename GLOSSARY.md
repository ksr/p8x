...
| **GTEXT** | RETIRED (2026-09-01, the single-interface migration): BASIC's software-rasterized bitmap text. PGC `TEXT` replaced it outright — stroke glyphs drawn card-side from the font the OS streams from `/FONT.GL` at boot. The idiom: `MOVE3 x,y,0 : TEXT s$`. |
